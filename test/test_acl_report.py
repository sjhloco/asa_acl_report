...
def test_format_data():
    ...
    assert acl == [['stecap', '1', 'permit', 'ip', 'any', 'any_port', 'any', 'any_port', '0', '0xeb4dc6c7'],
                   ...
                   ['mgmt', '9', 'permit', 'tcp', '10.10.10.1/32', '67-68', '20.20.20.1/32', '67-68', '0', '0x4ce78374', 'inactive'],
                   ...
                   ['Outside_mpc', '1', 'permit', 'icmp', 'any', 'any_port', 'any', 'echo-reply', '30', '0x7abb3943'],
                   ['Outside_mpc', '2', 'permit', 'ip', 'any', 'any_port', '185.4.167.128/28', 'any_port', '0', '0x17ad26ee', 'inactive'],
                   ['Outside_mpc', '3', 'permit', 'tcp', 'any', 'any_port', '10.255.111.85/32', 'https', '96119', '0xdcb8ce02'],
                   ['Outside_mpc', '3', 'permit', 'tcp', 'any', 'any_port', '10.255.111.85/32', 'ldaps', '15681', '0xa3fab9c6'],
                   ['Outside_mpc', '3', 'permit', 'tcp', 'any', 'any_port', '10.255.111.85/32', 'ldap', '2582', '0x906a26ba'],
                   ['Outside_mpc', '4', 'permit', 'udp', '10.255.111.85/32', 'any_port', '10.255.211.211/32', '53', '114382', '0xf2f882b5'],
                   ['Outside_mpc', '5', 'permit', 'udp', 'interface', 'any_port', '10.255.120.14/32', 'domain', '0', '0xa6499384'],
                   ['Outside_mpc', '5', 'permit', 'tcp', 'interface', 'any_port', '10.255.120.14/32', 'domain', '0', '0xcb50d649'],
                   ['Outside_mpc', '6', 'deny', 'icmp', 'any', 'any_port', 'any', 'any_port', '0', '0x2cf38cd2'],
    ...
    assert final_acl == [['stecap', '1', 'permit', 'ip', 'any', 'any_port', 'any', 'any_port', '0', None, ''],
                         ['stecap', '2', 'permit', 'tcp', '10.10.10.0/32', 'any_port', 'any', '443', '0', None, ''],
                         ['stecap', '2', 'permit', 'tcp', 'any', 'any_port', '10.10.10.0/24', '443', '0', None, ''],
                         ['mgmt', '2', 'permit', 'icmp', 'any', 'any_port', 'any', 'echo', '13759', '2020-02-26', '21:43:31'],
                         ['mgmt', '3', 'permit', 'icmp', '1.1.1.1/32', 'any_port', 'any', 'echo-reply', '0', None, ''],
                         ['mgmt', '4', 'permit', 'icmp', 'any', 'any_port', '2.2.2.2/32', 'unreachable', '3028', '2020-03-06', '22:13:24'],
                         ['mgmt', '5', 'permit', 'icmp', '10.10.10.0/24', 'any_port', 'any', 'time-exceeded', '0', None, ''],
                         ['mgmt', '5', 'permit', 'icmp', 'any', 'any_port', '10.10.10.0/24', 'time-exceeded', '0', None, ''],
                         ['mgmt', '6', 'deny', 'icmp', 'any', 'any_port', 'any', 'any_port', '0', None, ''],
                         ['mgmt', '9', 'permit', 'tcp', '10.10.10.1/32', '67-68', '20.20.20.1/32', '67-68', '0', None, '', 'inactive'],
                         ['mgmt', '10', 'permit', 'tcp', 'any', '22', '20.20.20.0/24', '67-68', '9222', None, ''],
                         ['mgmt', '11', 'permit', 'tcp', '10.10.10.1/32', '67-68', 'any', '22', '0', None, ''],
                         ['mgmt', '12', 'permit', 'tcp', '20.20.20.0/24', '22', 'any', '22', '1227', '2020-02-26', '19:22:40'],
                         ['Outside_mpc', '1', 'permit', 'icmp', 'any', 'any_port', 'any', 'echo-reply', '30', None, ''],
                         ['Outside_mpc', '2', 'permit', 'ip', 'any', 'any_port', '185.4.167.128/28', 'any_port', '0', None, '', 'inactive'],
                         ['Outside_mpc', '3', 'permit', 'tcp', 'any', 'any_port', '10.255.111.85/32', 'https', '96119', None, ''],
                         ['Outside_mpc', '3', 'permit', 'tcp', 'any', 'any_port', '10.255.111.85/32', 'ldaps', '15681', None, ''],
                         ['Outside_mpc', '3', 'permit', 'tcp', 'any', 'any_port', '10.255.111.85/32', 'ldap', '2582', None, ''],
                         ['Outside_mpc', '4', 'permit', 'udp', '10.255.111.85/32', 'any_port', '10.255.211.211/32', '53', '114382', None, ''],
                         ['Outside_mpc', '5', 'permit', 'udp', 'interface', 'any_port', '10.255.120.14/32', 'domain', '0', None, ''],
                         ['Outside_mpc', '5', 'permit', 'tcp', 'interface', 'any_port', '10.255.120.14/32', 'domain', '0', None, ''],
                         ['Outside_mpc', '6', 'deny', 'icmp', 'any', 'any_port', 'any', 'any_port', '0', None, ''],
                         ['outside', '2', 'deny', 'tcp', 'any', 'www', 'any', 'any_port', '0', None, ''],
                         ['outside', '2', 'deny', 'tcp', 'any', 'https', 'any', 'any_port', '0', None, ''],
                         ['outside', '3', 'deny', 'ip', 'any', 'any_port', '10.10.10.0/24', 'any_port', '24876', '2020-03-05', '00:29:25'],
                         ['outside', '3', 'deny', 'ip', 'any', 'any_port', '10.10.20.0/24', 'any_port', '0', None, '']]